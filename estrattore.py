...
def main():
    ...
    # ⚠️ METTI QUI IL NUOVO ID DELLA CARTELLA NELLO SHARED DRIVE ⚠️
    target_folder_id = "IL_TUO_NUOVO_ID_CARTELLA_QUI" 
    ...
    try:
        ...
        print("❌ Errore: Colonne mancanti.")
        return

    print("📸 Bot Fotografo - Versione Shared Drive attivo!")
    ...
    for i in range(1, len(dati)):
        ...
        if url_social.startswith('http') and not foto1_attuale:
            ...
            print("📥 Estrazione del video dal social in corso...")
            ydl_opts = {
                'format': 'best',
            ...
            # --- SERVIZIO FOTOGRAFICO E UPLOAD SU SHARED DRIVE ---
            timestamps = ['00:00:02', '00:00:05', '00:00:08', '00:00:11', '00:00:14']
            formule_foto = []
            
            print("📸 Scatto 5 fotogrammi e li carico sullo Shared Drive...")
            for idx, ts in enumerate(timestamps):
                ...
                if os.path.exists(nome_foto_jpg):
                    ...
                    # ⚠️ supportsAllDrives=True È LA CHIAVE PER FARLO FUNZIONARE SU SHARED DRIVE
